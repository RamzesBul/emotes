...
import io.github.kosmx.emotes.EmotecraftClientMod;
...
public class EmotecraftClientModNeo extends EmotecraftClientMod {

    public EmotecraftClientModNeo(ModContainer container, IEventBus modEventBus) {
